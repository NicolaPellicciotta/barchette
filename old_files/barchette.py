...
def arrange_barchette(vela_size=array([2.,10.,5.]),support_size = array([2.,2.,3.]),Dr=65,inverted=True,R_vela=None,speed=100.,xyres=0.25,zres=0.9):
    ...
    for i in arange(len(Xc)):
        ...
        temp=make_barchetta(vela_size=vela_size,support_size=support_size,inverted=inverted,R_vela=R_vela,speed=speed,xyres=xyres,zres=zres)
